    ...
    <Menu>
      <MenuHandler>
        <IconButton variant="text">
          <BellIcon className="h-[24px] w-[24px] text-text" />
        </IconButton>
      </MenuHandler>
      <MenuList className="flex flex-col gap-2">
        <MenuItem className="flex items-center gap-4 py-2 pr-8 pl-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              <ClockIcon className="h-[14px] w-[14px] text-text" />
              13 minutes ago
            </Typography>
          </div>
        </MenuItem>
        <MenuItem className="flex items-center gap-4 py-2 pr-8 pl-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Typography
              ...
              className="flex items-center gap-1 text-xs text-gray-600"
            >
              <ClockIcon className="h-[14px] w-[14px] text-text" />a hour ago
            </Typography>
          </div>
        </MenuItem>
        <MenuItem className="flex items-center gap-4 py-2 pr-8 pl-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Typography
              ...
              className="flex items-center gap-1 text-xs text-gray-600"
            >
              <ClockIcon className="h-[14px] w-[14px] text-text" />5 hours ago
            </Typography>
          </div>
        </MenuItem>
      </MenuList>
